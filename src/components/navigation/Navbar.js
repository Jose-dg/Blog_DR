            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
                ...
                <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                    ...
                    <NavLink to="/courses" className="mx-4 text-lg dark:hover:text-white hover:text-blue-600 text-gray-600 dark:text-dark-txt text-md font-gilroy-semibold">
                        Cursos
                    </NavLink>
                    ...
                    <NavLink to="/contact" className="mx-4 text-lg dark:hover:text-white hover:text-blue-600 text-gray-600 dark:text-dark-txt text-md font-gilroy-semibold">
                        Contacto
                    </NavLink>
{/*                                         
                    {
